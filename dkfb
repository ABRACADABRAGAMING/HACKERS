...
def loginSC():
	...
	if username =="ABRACADABRA" and password =="GAMING":
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://www.youtube.com/ABRACADABRAGAMING')
				menu()
